...
class CompositeSpecificationSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('RayRutjes\Domain\Specification\CompositeSpecification');
    }
    ...
    public function it_can_only_be_initialized_with_specifications($spec1)
    {
        ...
        $exception = new \InvalidArgumentException('RayRutjes\Domain\Specification expected');
